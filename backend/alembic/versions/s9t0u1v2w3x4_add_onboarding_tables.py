...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("bgc_status", sa.Text(), nullable=False, server_default=sa.text("'manual'")),
        sa.Column("drug_test_status", sa.Text(), nullable=False, server_default=sa.text("'manual'")),
