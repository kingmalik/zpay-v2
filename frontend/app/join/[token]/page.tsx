...
const S = {
  ...
  download_app: {
    title: { en: 'Download App & Complete Profile', ar: 'حمّل التطبيق وأكمل ملفك', am: 'መተግበሪያ ያውርዱ እና መገለጫ ያጠናቅቁ' },
    description: { en: 'First: Download the FirstAlt app using the invite link in your email. Fill in ALL your information inside the app completely. Once your profile is done, Acumen will contact Brandon to send you a background check link. When that email arrives from First Advantage — do NOT click the link — just forward it to contact.acumenintl@gmail.com and text Acumen to confirm.', ar: 'أولاً: حمّل تطبيق FirstAlt باستخدام رابط الدعوة في بريدك. أدخل جميع معلوماتك داخل التطبيق بالكامل. بمجرد اكتمال ملفك، سيتصل أكيومن ببراندون لإرسال رابط فحص الخلفية إليك. عندما يصل ذلك البريد من First Advantage — لا تنقر على الرابط — فقط أعد توجيهه إلى contact.acumenintl@gmail.com وأرسل رسالة نصية لأكيومن للتأكيد.', am: 'መጀመሪያ: በኢሜይልዎ ውስጥ ባለው ግብዣ ሊንክ FirstAlt መተግበሪያ ያውርዱ። ሁሉም መረጃዎን ሙሉ በሙሉ በመተግበሪያ ውስጥ ይሙሉ። መገለጫዎ ሲጠናቀቅ አኩመን ብራንዶንን አግኝቶ የጀርባ ምርመራ ሊንክ ይልክሎዎታል። ያ ኢሜይል ከFirst Advantage ሲደርስ — ሊንኩን አይጫኑ — ወደ contact.acumenintl@gmail.com ፎርዋርድ ያድርጉ እና ለአኩመን ጽሑፍ ይላኩ።' },
