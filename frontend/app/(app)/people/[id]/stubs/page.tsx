  ...
  return (
    ...
    >
      <motion.div
        ...
        className="dark:bg-[#0f1729] bg-white rounded-2xl border dark:border-white/10 border-gray-200 p-6 w-full max-w-md max-h-[calc(100dvh-2rem)] overflow-y-auto shadow-xl"
