...
const T = {
  ...
  m1_steps: {
    en: [
      ...
      ['MARK ARRIVAL', 'When you pull up to the pickup address, mark your arrival in the app. This starts your 10-minute wait timer.'],
      ['WAIT 10 FULL MINUTES', 'If the student does not come out, you must wait the full 10 minutes. Do not mark No-Load before 10 minutes. Call dispatch if there is no answer.'],
    ...
    ar: [
      ...
      ['سجّل الوصول', 'عند وصولك لعنوان الالتقاء، سجّل وصولك في التطبيق. هذا يبدأ مؤقت الانتظار 10 دقائق.'],
      ['انتظر 10 دقائق كاملة', 'إذا لم يخرج الطالب، يجب أن تنتظر 10 دقائق كاملة. لا تسجل بدون حمولة قبل 10 دقائق. اتصل بالمرسل إذا لم يكن هناك رد.'],
    ...
    am: [
      ...
      ['መድረስዎን ያመልክቱ', 'ወደ ማንሻ አድራሻ ሲደርሱ፣ በመተግበሪያ ውስጥ መድረስዎን ያመልክቱ። ይህ የ10 ደቂቃ ጊዜ ቆጣሪዎን ያስጀምራል።'],
      ['10 ደቂቃ ሙሉ ይጠብቁ', 'ተማሪው ካልወጣ 10 ደቂቃ ሙሉ መጠበቅ አለብዎት። ከ10 ደቂቃ በፊት ባዶ ጉዞ አያስመዝግቡ። መልስ ከሌለ ለዲስፓች ይደውሉ።'],
